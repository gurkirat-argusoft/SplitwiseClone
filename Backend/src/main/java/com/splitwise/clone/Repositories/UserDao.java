...
public interface UserDao extends JpaRepository<User, Integer> {
    ...
    @Query(value = "select u.user_id , u.user_name,u.email , u.image_url,u.phone_no,u.password from  friends friend join user u on friend.friend_id=u.user_id where friend.user_id= :userId;",nativeQuery = true)
